            ...
            <div className="grid lg:grid-cols-5 gap-8">
                ...
                <div className="lg:col-span-2 space-y-4">
                    <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-[var(--shadow-card)]">
                        ...
                        <p className="text-4xl font-black text-primary font-display tabular-nums">₹{Math.round(emi).toLocaleString('en-IN')}<span className="text-base font-medium text-slate-400">/month</span></p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-100 p-6 shadow-[var(--shadow-card)]">
                        ...
                        <div className="flex justify-center mb-6">
                            <div className="relative size-40">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                    ...
                                    <p className="text-xl font-black text-primary font-display tabular-nums">₹{(totalPayable / 100000).toFixed(1)}L</p>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm font-bold text-primary tabular-nums">₹{loanAmount.toLocaleString('en-IN')}</span>
                            </div>
                            <div className="flex items-center justify-between">
